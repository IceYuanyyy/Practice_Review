...
- **🧘 禅模式 2.0**:
  ...
  - 新增"防走神"监测（鼠标移出/页面失焦震动提醒）
  - 优化计时器与白噪音（视觉）反馈

</details>

<details>
<summary>v1.1.2 (2026-01-07) · 展开查看</summary>

- 🐛 重置轮次时同步清理当前轮次的练习记录，确保答题卡状态与历史彻底归零（如“习思想2”等科目重置后不再显示已做痕迹）

</details>

<details>
<summary>v1.1.1 (2026-01-07) · 展开查看</summary>

- **💄 界面优化**:
  - 优化错题本 (WrongBook) 卡片样式，增加科目标签显示
  - 重构练习页 (Practice) "当前状态"面板，新增笔记本风格主题
  - 修复错题练习模式下科目名称显示不正确的问题
- **🐛 问题修复**:
  - 修复练习页答题卡跳转导致已做数量异常累加的问题（已答题数仅统计提交过的题目）

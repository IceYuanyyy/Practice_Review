...
<details open>
<summary>v1.1.5 (2026-01-12) · 🔍 错题检索 & 🗑️ 精准移除 & 🐛 持久化修复</summary>

- **🔍 错题本检索增强 (WrongBook)**:
  - **双级搜索体系**: 新增 "科目筛选 (Level 1)" 与 "题目名称搜索 (Level 2)" 的组合检索能力，精准定位薄弱点
  - **交互栏升级**: 在错题墙上方集成手绘风搜索工具栏，支持回车键快速查询
- **🗑️ 错题精准管理 (Feature)**:
  - **单题移除**: 错题卡片新增 "🗑️ 删除" 按钮，支持手动移除由于误触或已完全掌握的特定题目
...
- **📊 个人练习与管理员侦查 (Feature)**:
  ...
  - **精细化穿透**: 档案库新增支持查看练习记录对应的 **题目 ID** 与 **题目原文内容**，支持超长内容 Tooltip 展示
